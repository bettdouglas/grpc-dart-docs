...
final $typed_data.Uint8List listHospitalsRequestDescriptor =
    $convert.base64Decode('ChRMaXN0SG9zcGl0YWxzUmVxdWVzdA==');
...
final $typed_data.Uint8List listHospitalsResponseDescriptor = $convert.base64Decode(
    'ChVMaXN0SG9zcGl0YWxzUmVzcG9uc2USOQoJaG9zcGl0YWxzGAEgAygLMhsuYWZyaWNhbl9ob3NwaXRhbHMuSG9zcGl0YWxSCWhvc3BpdGFscw==');
...
final $typed_data.Uint8List getHospitalRequestDescriptor =
    $convert.base64Decode('ChJHZXRIb3NwaXRhbFJlcXVlc3QSDgoCaWQYASABKAlSAmlk');
...
final $typed_data.Uint8List searchHospitalsRequestDescriptor =
    $convert.base64Decode(
        'ChZTZWFyY2hIb3NwaXRhbHNSZXF1ZXN0EhgKB2NvdW50cnkYASABKAlSB2NvdW50cnkSEgoEbmFtZRgCIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List searchHospitalsResponseDescriptor =
    $convert.base64Decode(
        'ChdTZWFyY2hIb3NwaXRhbHNSZXNwb25zZRI5Cglob3NwaXRhbHMYASADKAsyGy5hZnJpY2FuX2hvc3BpdGFscy5Ib3NwaXRhbFIJaG9zcGl0YWxz');
...
final $typed_data.Uint8List hospitalDescriptor = $convert.base64Decode(
    'CghIb3NwaXRhbBIOCgJpZBgBIAEoCVICaWQSEgoEbmFtZRgCIAEoCVIEbmFtZRISCgR0eXBlGAMgASgJUgR0eXBlEhwKCW93bmVyc2hpcBgEIAEoCVIJb3duZXJzaGlwEjEKBmxhdExuZxgFIAEoCzIZLmFmcmljYW5faG9zcGl0YWxzLkxhdExuZ1IGbGF0TG5nEhgKB2NvdW50cnkYBiABKAlSB2NvdW50cnk=');
...
final $typed_data.Uint8List latLngDescriptor = $convert.base64Decode(
    'CgZMYXRMbmcSGgoIbGF0aXR1ZGUYASABKAJSCGxhdGl0dWRlEhwKCWxvbmdpdHVkZRgCIAEoAlIJbG9uZ2l0dWRl');
